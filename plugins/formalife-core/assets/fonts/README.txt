Font locali richiesti da assets/css/fonts.css (formalife-core)
==============================================================

Questo plugin (formalife-core) fornisce i font condivisi a tutti i plugin
Formalife che dipendono da esso — non scarica font da Google Fonts
(fonts.googleapis.com / fonts.gstatic.com). I font vengono dichiarati con
@font-face locali in assets/css/fonts.css e devono essere forniti come file
WOFF2 legittimamente licenziati, copiati manualmente in questa cartella
(assets/fonts/).
...
disco, vedi formalife_core_output_font_preloads() in
includes/formalife-core-functions.php — ogni plugin consumatore vi passa la
propria lista di pesi critici).
